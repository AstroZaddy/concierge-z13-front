...
export function TransitsPage() {
  ...
  useEffect(() => {
    ...
    // Fetch transits aspects
    setLoading(true);
    setError(null);

    fetch(`${API_BASE_URL}/transits/aspects/now`, {
      method: "POST",
      headers: {
    ...
    return (
      <section className="min-h-screen px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="p-8 rounded-xl bg-white/5 border border-amber-500/30 backdrop-blur-sm shadow-glow text-center">
    ...
    <section className="min-h-screen px-4 py-20">
                ...
                return (
                  <div
                    ...
                    className={`p-6 rounded-xl bg-white/5 border border-gray-700/40 backdrop-blur-sm transition-all duration-300 ${
                      hasAspects ? "cursor-pointer hover:shadow-neon shadow-neon" : ""
                    }`}
      ...
      {modalAspect && (() => {
        ...
        return (
          ...
          >
            <div
              className="relative max-w-2xl w-full max-h-[90vh] overflow-y-auto rounded-xl bg-[#0a0a12] border border-purple-500/30 shadow-glow p-6 md:p-8"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button */}
              <button
